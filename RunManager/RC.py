...
class RC:
	...
	self.properties = "-Dpegasus.catalog.replica=JDBCRC -Dpegasus.catalog.replica.db.driver=MySQL -Dpegasus.catalog.replica.db.url=%s -Dpegasus.catalog.replica.db.user=%s -Dpegasus.catalog.replica.db.password=%s" % (self.rc_path, RC_USER, RC_PASS)
        return
